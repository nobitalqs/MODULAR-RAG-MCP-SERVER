...
|-------|-------|-------------|------------|
| 1 | `spec-sync` | Sync spec documents | `.claude/skills/spec-sync/SKILL.md` |
| 2 | `progress-tracker` | Find next task | `.claude/skills/progress-tracker/SKILL.md` |
| 3 | `implement` | Execute implementation | `.claude/skills/implement/SKILL.md` |
| 4 | `testing-stage` | Run tests | `.claude/skills/testing-stage/SKILL.md` |
| 5 | `checkpoint` | Save progress | `.claude/skills/checkpoint/SKILL.md` |
