...
> Spec files are located at: `.claude/skills/spec-sync/specs/`
...
- **First**, read `.claude/skills/spec-sync/SPEC_INDEX.md` to locate the relevant chapter.
- **Then**, read only the specific chapter file from `.claude/skills/spec-sync/specs/`.
...
**Chapter Reference Quick Guide** (files in `.claude/skills/spec-sync/specs/`):
