...
```bash
# Normal sync
python .claude/skills/spec-sync/sync_spec.py

# Force regenerate (even if no changes detected)
python .claude/skills/spec-sync/sync_spec.py --force
```
...
```
Read: .claude/skills/spec-sync/SPEC_INDEX.md
```
...
```
Read: .claude/skills/spec-sync/specs/05-architecture.md
```
