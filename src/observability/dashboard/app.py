...
pages = [
    st.Page(_page_overview, title="Overview", icon=":material/monitoring:", default=True),
    st.Page(_page_data_browser, title="Data Browser", icon=":material/search:"),
    st.Page(_page_ingestion_manager, title="Ingestion Manager", icon=":material/upload:"),
    st.Page(_page_ingestion_traces, title="Ingestion Traces", icon=":material/labs:"),
    st.Page(_page_query_traces, title="Query Traces", icon=":material/manage_search:"),
    st.Page(_page_evaluation_panel, title="Evaluation Panel", icon=":material/speed:"),
]
