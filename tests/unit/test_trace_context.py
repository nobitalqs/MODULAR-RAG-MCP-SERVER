...
Covers:
- TraceContext init defaults and trace_type
- record_stage appending and timing
- get_stage_data backward-compat helper
- finish() lifecycle and elapsed freezing
- elapsed_ms total and per-stage
- to_dict() serialisation
- TraceCollector JSON Lines persistence
"""
...
class TestToDict:
    ...
    def test_contains_required_keys(self) -> None:
        ...
        d = tc.to_dict()
        for key in (
            "trace_id", "trace_type", "started_at",
